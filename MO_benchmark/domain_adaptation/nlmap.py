...
def solution_transform(solution, M):
    # To return transformed solutions such that their variables are bounded in [0, 1]
...
class NonlinearTrans(object):
    ...
    def learn(self, source_solutions, target_solutions, reg):
        ...
        for i in range(self.outputs):
            temp1 = sp.linalg.inv(np.matmul(layer1_transformation, layer1_transformation.transpose()) + reg*np.identity(self.hidden_nodes))
